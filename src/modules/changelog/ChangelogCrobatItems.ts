...
const ChangelogCrobatItems = [
    ...
    // ⥂⥄
    new ChangelogUpdate('v0.2.12', new Date(2022, 8 - 1, 3)),
    new Changelog(changelogType.NEW, 'Added Day/Night feature'),
    ...
    new Changelog(changelogType.CHANGE, 'Beast Balls won\'t be used automatically with any other ball selected anymore'),
